...
class Pemilua extends CI_Controller {
        ...
        foreach ($konflik as $field) {
            ...
            $row[] = " <div class='dropdown dropdown-inline'>
                            ...
                            <div class='dropdown-menu dropdown-menu-right'>
                                <a class='dropdown-item edit_btn' href='javascript:void(0)'  data-toggle='modal' data-id='".$field->IDTRXPEMILU."'  data-idpol='".$field->IDPARPOL."' data-pol='".$field->NMPARPOL."'  data-idkab='".$field->IDWIL."' data-kab='".$field->NMWIL."'  data-idkec='".$field->IDKEC."' data-kec='".$field->NMKEC."' data-thn='".$field->NMTAHUN."'  data-idthn='".$field->IDTAHUN."' data-suara='".$field->TOTALSUARA."'  ><i class='la la-pencil-square  '></i> Edit</a>
                                
                                <a class='dropdown-item delete_btn' href='javascript:void(0)' data-toggle='modal' data-id='".$field->IDTRXPEMILU."' data-target='#delete'><i class='la la-trash-o  '></i> Hapus</a>
                            </div>
                        </div>";            
            $data[] = $row;
        }
