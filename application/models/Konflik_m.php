...
class Konflik_m extends CI_Model {
    ...
    var $column_order = array(null, 'tr_angket.IDTRXANGKET','m_kecamatan.NMKEC'); //field yang ada di table user
    ...
    {
        $this->db->select('IDTRXANGKET,tr_angket.DESKRIPSI, NMANGKET,STATUS, m_status.NMSTATUS, TGLANGKET, tr_angket.IDKEC,m_kabkota.NMWIL,m_kabkota.IDWIL, NMKEC, tr_angket.IDBENTUK, NMBENTUK, tr_angket.IDDESA, m_desakel.NMDESA');
