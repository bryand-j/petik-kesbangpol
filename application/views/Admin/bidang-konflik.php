            ...
            <div class="modal-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                       ...
                       <input type="color" class="form-control form-control-sm" name="warna" placeholder="Masukan Kode Warna Wilayah ( Contoh :red = merah)">
                    </div>
                      <div class="form-group">
                                        ...
                                        <form method="post" action="bidang/edit">  
                                            ...
                                            <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                     ...
                                                     <div class="form-group">
                                                        <label for="recipient-name" class="form-control-label">Warna</label>
                                                       <input type="color" class="form-control form-control-sm" name="warna" value="<?=$row->WARNABNTK ?>" >
                                                    </div>
                                                   <div class="form-group">
                                                      <label for="recipient-name" class="form-control-label">Deskripsi</label>
