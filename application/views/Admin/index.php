...
<div class="kt-portlet kt-portlet--height-fluid">
    <div class="kt-widget14">
        <div class="kt-widget14__header kt-margin-b-30">
            ...
            <span class="kt-widget14__desc" style="color: black;">
                Data Wilayah  ( Desa,  Kecamatan, Kabupaten/Kota )
            </span></center>
        </div>
        <center>
        	<a href="<?php echo base_url()?>Admin/desa">
            <div class="col-xl-4 col-lg-3 order-lg-1 order-xl-1" style="display: inline-block;">     
                <div class="kt-portlet kt-portlet--height-fluid" style=" background: url('<?php echo base_url("assets/media/desaa.png")?>') no-repeat ; background-position: center;
                    ...
                    <div class="kt-widget14">
                        <div class="kt-widget14__header kt-margin-b-30">
                           <!--  <h3 class="kt-widget14__title">
                            ...
                            <span class="kt-widget14__desc" style="color: black;"> 
                              <b> <h2><?=$jmlkec->KEC;?></h2>Kecamatan  </b>
                            </span>
                             <!-- <img style="width: 100%;height:30px;" src="<?php echo base_url("assets/media/desa.png")?>"> -->
                        </div>                      
                    </div>
                </div>  
             </div></a>

             <a href="<?php echo base_url()?>Admin/kabupaten">
                       <div class="col-xl-4 col-lg-3 order-lg-1 order-xl-1" style="display: inline-block;">     
                <div class="kt-portlet kt-portlet--height-fluid" style=" background: url('<?php echo base_url("assets/media/desaa.png")?>') no-repeat ; background-position: center;
    background-size: contain;">
                    <div class="kt-widget14">
                        <div class="kt-widget14__header kt-margin-b-30">
                           <!--  <h3 class="kt-widget14__title">
                            ...
                            <span class="kt-widget14__desc" style="color: black;">
                              <b>  <h2><?=$jmlkab->KAB;?></h2> Kabupaten / Kota   </b>  
                            </span>
                             <!-- <img style="width: 100%;height:30px;" src="<?php echo base_url("assets/media/desa.png")?>"> -->
                        </div>                      
                    </div>
