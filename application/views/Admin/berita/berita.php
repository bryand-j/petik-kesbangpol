...
<!-- 	<a href="#" class="btn btn-clean btn-icon-sm">
	...
	<div class="dropdown dropdown-inline">
		<a type="button" class="btn btn-outline-primary btn-icon-sm btn-sm" href="<?=base_url()?>admin/berita/inputform" title="Tambah Data Berita" >
                        ...
                        <td>
                            <div class='dropdown dropdown-inline'>
                                ...
                                <div class='dropdown-menu dropdown-menu-right'>
                                    <a class='dropdown-item edit_btn' href="<?=base_url()?>admin/berita/editform/<?=$row->IDKONFLIK ?>"><i class='la la-pencil-square  '></i> Edit</a>
                                ...
                                <div class="modal-dialog modal-md" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a  id="del-kec" class="btn btn-primary" href="<?=base_url()?>admin/berita/delete/<?=$row->IDKONFLIK ?>">Hapus</a>
                                        </div>
