            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control form-control-sm" id="in-pol"> 
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control form-control-sm" id="in-thn"> 
    ...
    $(document).ready(function() {     
      ...
      load();     
       ...
       table = $('#kt_table').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?php echo site_url('pemilua/view')?>",
                "type": "POST",
                "data": function ( data ) {
   ...
   $('#save').click(function(){
    ...
    function input(){       
      ...
      var suara = $('#suara').val();  
         ...
         $.ajax({
          type:'POST',
           url: "<?php echo site_url('pemilua/input')?>",
    ...
    $('body').on('click','.edit_btn',function(){ 
      ...
      $('#btn-edit').click(function(){ //button filter event click    
           ...
           var suara = $('#esuara').val();          
               ...
               $.ajax({
              type:'POST',
               url: "<?php echo site_url('pemilua/edit')?>",
