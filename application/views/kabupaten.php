                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <div class="form-group">
                       ...
                       <input type="text" class="form-control " name="warna" placeholder="Masukan Kode Warna Wilayah ( Contoh :red = merah)">
                    </div>
                     <div class="form-group">
                                            ...
                                            <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                     ...
                                                     <div class="form-group">
                                                      ...
                                                      <div class="form-group">
                                                        <label for="recipient-name" class="form-control-label">Kode Warna</label>
                                                       <input type="text" class="form-control " name="warna" value="<?=$row->WARNAK ?>"  placeholder="Masukan Kode Warna Wilayah ( Contoh :red = merah)">
                                                    </div>
                                                     <div class="form-group" >
                                                        <label>File Geojson Kabupaten</label>
                                                        <div></div>
