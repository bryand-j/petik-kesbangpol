...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo base_url()?>assets/service/DataTables/bootstrap.min.css"/>
	<link rel="stylesheet" type="text/css" href="<?php echo base_url()?>assets/service/DataTables/dataTables.bootstrap4.min.css"/>
...
<script type="text/javascript" src="<?php echo base_url()?>assets/service/DataTables/jquery-3.3.1.min.js"></script>
<script type="text/javascript" src="<?php echo base_url()?>assets/service/DataTables/datatables.min.js"></script>
<script type="text/javascript" src="<?php echo base_url()?>assets/service/DataTables/dataTables.bootstrap4.min.js"></script>
<script>
