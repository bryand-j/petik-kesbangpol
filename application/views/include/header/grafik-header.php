    ...
    <div class="container">
      ...
      <nav class="nav-menu float-right d-none d-lg-block">
        <ul>
          ...
          <li class="active" onclick="window.location.href='<?=base_url()?>home/service?page=Grafik';"><a href="">Grafik</a></li>
          <li onclick="window.location.href='<?=base_url()?>home/service?page=Data';"><a href="">Data</a></li>
          <li onclick="window.location.href='<?=base_url()?>home/service?page=pemilu';"><a href="">Peta Pemilu</a></li>
