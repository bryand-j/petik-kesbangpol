...
var KTDatatableJsonRemoteDemo={
	init:function(){
		var t;t=$(".kt-datatable").KTDatatable({
			data:{
				type:"remote",source:"https://keenthemes.com/metronic/tools/preview/api/datatables/datasource/default.json",
				pageSize:10
			},
			layout:{
				scroll:!1,
